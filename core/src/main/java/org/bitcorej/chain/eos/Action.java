...
import org.bitcorej.chain.eos.types.TypeAccountName;
import org.bitcorej.chain.eos.types.TypeActionName;
import org.bitcorej.chain.eos.types.TypePermissionLevel;
...
public class Action implements EosType.Packer {
    ...
    public void pack(EosType.Writer writer) {
        ...
        if ( null != data ) {
            byte[] dataAsBytes = NumericUtil.hexToBytes( data.getAsString());
