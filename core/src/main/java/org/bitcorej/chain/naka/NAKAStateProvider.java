...
public class NAKAStateProvider extends EthereumStateProvider {
    @Override
    public String signRawTransaction(String rawTx, List<String> keys) {
        ...
        String signedTx = NumericUtil.bytesToHex(TransactionEncoder.signMessage(tx, 2019L, Credentials.create(keys.get(0))));
