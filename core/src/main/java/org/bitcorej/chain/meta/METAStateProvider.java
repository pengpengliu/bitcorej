package org.bitcorej.chain.meta;
...
public class METAStateProvider extends EthereumStateProvider {
    @Override
    public String signRawTransaction(String rawTx, List<String> keys) {
        ...
        String signedTx = NumericUtil.bytesToHex(TransactionEncoder.signMessage(tx, (byte)11, Credentials.create(keys.get(0))));
