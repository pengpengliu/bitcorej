package org.bitcorej.chain.bsc;
...
public class BSCStateProvider extends EthereumStateProvider {
    @Override
    public String signRawTransaction(String rawTx, List<String> keys) {
        ...
        String signedTx = NumericUtil.bytesToHex(TransactionEncoder.signMessage(tx, (byte)56, Credentials.create(keys.get(0))));
