package org.bitcorej.chain.luna;
...
public class LUNAStateProvider extends CosmosStateProvider {
    public LUNAStateProvider() {
        super.bech32AccAddr = "terra";
        super.transferPrefix = "bank/MsgSend";
    }
    ...
    public String signRawTransaction(String rawTx, List<String> keys) {
        ...
        String msg = "{\"account_number\":\"" + accountNumber + "\",\"chain_id\":\"" + chainId + "\",\"fee\":{\"amount\":[{\"amount\":\"" + feeAmount + "\",\"denom\":\"" + feeDenom + "\"}],\"gas\":\"" + gas +"\"},\"memo\":\"" + memo +"\",\"msgs\":[{\"type\":\"bank/MsgSend\",\"value\":{\"amount\":[{\"amount\":\"" + toAmount + "\",\"denom\":\"" + toDenom + "\"}],\"from_address\":\"" + from + "\",\"to_address\":\"" + to + "\"}}],\"sequence\":\"" + sequence + "\"}";
